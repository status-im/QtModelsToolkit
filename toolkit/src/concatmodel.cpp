...
/*!
    ...
    \l {ConcatModel::markerRoleName}. Value of this role may be set separately
...
/*!
    \qmlproperty any SourceModel::model
...
/*!
    \qmlproperty any SourceModel::markerRoleValue
...
/*!
    \qmlproperty list<SourceModel> ConcatModel::sources
...
/*!
    \qmlproperty string ConcatModel::markerRoleName
...
/*!
    \qmlproperty list<string> ConcatModel::expectedRoles
...
/*!
    \qmlproperty bool ConcatModel::propagateResets
...
/*!
    \qmlmethod int ConcatModel::sourceModelRow(row)

    Returns the row index inside the source model for a given \a row of the
    proxy.
*/
...
/*!
    \qmlmethod QAbstractItemModel* ConcatModel::sourceModel(row)

    Returns the source model for a given \a row of the proxy.
*/
...
/*!
    \qmlmethod int ConcatModel::fromSourceRow(model, row)

    Returns the row number of the ConcatModel for a given source \a model and
    source model's \a row index.
*/
