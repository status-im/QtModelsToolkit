...
/*!
    ...
    \ingroup Utilities
    \brief Utility allowing handy binding to a single row from a model.

    In opposition to accessing model data via methods like \c ListModel::get
    or \c QAbstractItemModel::data, \l ModelEntry gives ability to conveniently
    bind to the pointed element.
*/
...
/*!
    \qmlproperty any ModelEntry::item
...
/*!
    \qmlproperty any ModelEntry::sourceModel
...
/*!
    \qmlproperty string ModelEntry::key
...
/*!
    \qmlproperty any ModelEntry::value
...
/*!
    \qmlproperty bool ModelEntry::available
...
/*!
    \qmlproperty list<string> ModelEntry::roles
...
/*!
    \qmlproperty int ModelEntry::row
...
/*!
    \qmlproperty bool ModelEntry::cacheOnRemoval

    Determines whether to cache the item when it is removed from the model.
    If true, the item will be cached and available until another source model is
    used or the cacheOnRemoval is set to false.
*/
...
/*!
    \qmlproperty bool ModelEntry::itemRemovedFromModel

    Determines whether the item was removed from the model. This flag is only
    set when cacheOnRemoval is true.
*/
