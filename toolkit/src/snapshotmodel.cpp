...
/*!
    ...
    \inmodule QtModelsToolkit
    \ingroup Utilities
    \brief Model allowing creation of static copy from another model.

    A deep copy is created, including submodels and QObject-based objects.
*/
